import { EmailOutlined, AddTaskOutlined, Phone, Place } from '@mui/icons-material';
...
const AgentCard = ({ id, name, email, avatar, noOfTasks }: AgentCardProp) => {
    ...
    >
      ...
      <Stack direction="column" justifyContent="space-between" flex={1} gap={{ xs: 4, sm: 2 }}>
        <Stack gap={2} direction="row" flexWrap="wrap" alignItems="center">
          ...
          <Typography fontSize={14} color="#808191">Developer</Typography>
        </Stack>
        <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
          ...
          />
          <InfoBar
            icon={<AddTaskOutlined sx={{ color: '#808191' }} />}
            name={`${noOfTasks} Tasks`}
          />
        </Stack>
      </Stack>
